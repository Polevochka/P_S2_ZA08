...
var
  i,j: integer;
  xy: integer; // ширина и высота ОДНОЙ ячейки таблицы
...
begin
  ...
  begin
    ...
    // Пусть вся таблица будет 300 x 300
    ...
    for i:= 0 to n -1 do
    begin
      RowHeights[i] := xy; // для каждой строки одна и та же высота
      ColWidths[i] := xy;   // для каждого столбца одна и та же ширина
    end;
